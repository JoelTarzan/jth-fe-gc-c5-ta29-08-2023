...
public class ViewEjercicio08 extends JFrame {
	...
	public ViewEjercicio08() {
		...
		btnConversor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(contentPane, "El valor introducido es incorrecto.");
				}
			}
		});
		btnConversor.setBounds(63, 85, 134, 23);
		btnConversor.setFocusable(true);
		...
		btnCambiarModo.setBounds(217, 85, 89, 23);
		btnCambiarModo.setFocusable(true);
		...
		btnBorrar.setBounds(331, 85, 89, 23);
